...
<body>
    ...
    <form action="answer_mod_proc.php" method="post">
        ...
        <div>
            <span class="ta_md"><textarea name="" placeholder="성희롱 및 욕설은 처벌대상입니다. 최대 1000자까지 작성 가능합니다.">기존 답변내용</textarea></span>
            <!-- db t_board 테이블의 해당 row answer 컬럼 데이터 가져오기 -->
        </div>
        <div class="bt">
            <span class="bt__md"><input type="submit" value="수정하기"></span>
            <!-- answer_mod_proc.php 실행됨 -->
            <span class="bt__cs"><input type="button" value="취소하기" onClick="location.href='detail.php'"></span>
            <!-- detail.php 페이지로 돌아감 -->
        </div>
    </form>
</body>
