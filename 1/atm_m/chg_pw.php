...
<body>
    ...
    <form action="chg_pw_proc.php" method="post">
        <div class="line">
            ...
            <span class="pr__ch"><input type="password" placeholder="현재 비밀번호를 입력하세요."></span>
        </div>
        <!--현재 비밀번호 : db에 현재 등록된 데이터와 일치하는지 확인-->
        <!-- css input 열 맞추기 -->
        <div class="line">
            <a class="tc__pw">새 비밀번호</a>
            <span class="pr__ch"><input type="password" placeholder="새 비밀번호를 입력하세요."></span>
        </div>
        <!--새 비밀번호 : 변경할 비밀번호 입력-->
        <div class="line">
            <a class="tc__pw">새 비밀번호 확인</a>
            <span class="pr__ch"><input type="password" placeholder="새 비밀번호를 재입력하세요."></span>
        </div>
