...
<body>
    ...
    <form action="myprofile_proc.php" method="post" enctype="multipart/form-data">
        <div class="Profile"> 
            <img style="width: 150px;" id="preview-image" src="img/profile/atm_basic.png">
            <input style="display: block;" type="file" id="input-image" name="img" accept="image/*">
            <?php
                    $session_img = $_SESSION["login_user"]["profile_img"];
                    $profile_img = $session_img == null ? "img/profile/atm_basic.png" : $_SESSION["login_user"]["i_user"] . "/" .$session_img; 
            ?>
            <script>
