...
<body>
  <div class="container">
      ...
      <div class="a_main">
        <div class="a_main_write">
          <div class="a_main_write_1">
            <span class="a_main_write_1_url">localhost/atm/main_2.php?i_user=<?=$i_user?></span>
            <span class="abc">
    ...
    <div class="a_footer">
            ...
            <div class="a_footer_notice"><a href="new_noti.php?i_user=<?=$i_user?>&i_board=<?=$i_board?>"><img src="img/notice.png" class="a_footer_notice_img"></a>
            <?php if($count>0){echo "
